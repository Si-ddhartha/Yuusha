...
class Weapon(pygame.sprite.Sprite):
    ...
    def __init__(self, player, groups):
        ...
        # Placement setup
        if direction == 'right':
            self.rect = self.image.get_rect(midleft = player.rect.midright + pygame.math.Vector2(-8, 15))
        
        elif direction == 'left':
            self.rect = self.image.get_rect(midright = player.rect.midleft + pygame.math.Vector2(8, 15))
